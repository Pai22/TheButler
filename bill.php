            ...
            <div class="col-md-5">
                <div class="card" style="height:520px;width:500px">
                    <div class="card-body">
                        ...
                        <p id="result">
                        <h5 class="card-text">รวมทั้งหมด:</h5><input type=text name="price" id="price" required class=form-control disabled style="height:30px;width:100px" oninput="calculate(this)"></p>
